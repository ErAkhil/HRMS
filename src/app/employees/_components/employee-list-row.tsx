  ...
  return (
    <div className="flex items-center gap-4 rounded-xl bg-white px-5 py-4 shadow-card dark:bg-dark-2 dark:border dark:border-dark-3">
      ...
      <div className="relative shrink-0">
        ...
        />
        <span
          className={`absolute bottom-0.5 right-0.5 h-2.5 w-2.5 rounded-full border-2 border-white dark:border-dark-2 ${STATUS_COLORS[employee.status]}`}
        />
      </div>
      ...
      {/* Department */}
      <span className={`hidden sm:inline-flex ${DEPARTMENT_COLORS[employee.department]}`}>
        {employee.department}
      </span>
