        ...
        <div ref={menuRef} className="relative">
          ...
          {openMenu === task.id && (
            <div className="absolute right-0 top-8 z-20 w-40 rounded-xl border border-gray-3 bg-white shadow-floating dark:border-dark-3 dark:bg-dark-2">
              <button
                onClick={() => { setOpenMenu(null); setToast("Task opened for editing!"); }}
              ...
              <button
                onClick={() => { setOpenMenu(null); setToast("Task moved to next stage!"); }}
                className="flex w-full items-center px-4 py-2.5 text-sm text-dark hover:bg-gray-1 dark:text-white dark:hover:bg-dark-3"
              >
                Move to Next Stage
              </button>
              <button
                onClick={() => { setOpenMenu(null); setToast("Assignee updated!"); }}
                className="flex w-full items-center px-4 py-2.5 text-sm text-dark hover:bg-gray-1 dark:text-white dark:hover:bg-dark-3"
              >
                Assign
              </button>
              <button
                onClick={() => { setOpenMenu(null); setToast("Task deleted!"); }}
                className="flex w-full items-center px-4 py-2.5 text-sm text-rose-dark hover:bg-gray-1 dark:hover:bg-dark-3 rounded-b-xl"
              >
                Delete
              </button>
            </div>
...
export default function KanbanPage() {
  ...
  const [preselectedColumn, setPreselectedColumn] = useState<ColumnKey>("todo");
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-floating dark:bg-dark-2">
            <div className="mb-5 flex items-center justify-between">
              <h2 className="text-base font-bold text-dark dark:text-white">New Task</h2>
              <button
            ...
            <div className="space-y-4">
              <div>
                <label className="mb-1.5 block text-xs font-medium text-dark-5 dark:text-dark-6">
                  Title <span className="text-rose-dark">*</span>
                </label>
                <input
                  type="text"
                  value={taskTitle}
              ...
              <div>
                <label className="mb-1.5 block text-xs font-medium text-dark-5 dark:text-dark-6">Project</label>
                <select
                  value={taskProject}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="mb-1.5 block text-xs font-medium text-dark-5 dark:text-dark-6">Column</label>
                  <select
                    value={taskColumn}
                    onChange={(e) => setTaskColumn(e.target.value as ColumnKey)}
                    className="w-full rounded-lg border border-gray-3 bg-gray-1 px-3 py-2 text-sm text-dark outline-none focus:border-primary-600 dark:border-dark-3 dark:bg-dark-3 dark:text-white"
                  >
              ...
              <div>
                <label className="mb-1.5 block text-xs font-medium text-dark-5 dark:text-dark-6">Assignee</label>
                <input
                  type="text"
                  value={taskAssignee}
              ...
              <div>
                <label className="mb-1.5 block text-xs font-medium text-dark-5 dark:text-dark-6">Due Date</label>
                <input
                  type="date"
                  value={taskDueDate}
