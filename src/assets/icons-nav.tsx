...
export function SearchIcon(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor" {...props}>
      ...
      <defs><clipPath id="clip0_1699_11536"><rect width="18" height="18" fill="white" /></clipPath></defs>
    </svg>
  );
}
...
export function ChevronUpIcon(props: IconProps) {
  return (
    <svg width={22} height={22} viewBox="0 0 22 22" fill="currentColor" {...props}>
      <path fillRule="evenodd" clipRule="evenodd" d="M10.551 7.728a.687.687 0 01.895 0l6.417 5.5a.687.687 0 11-.895 1.044l-5.97-5.117-5.969 5.117a.687.687 0 01-.894-1.044l6.416-5.5z" />
    </svg>
  );
}
